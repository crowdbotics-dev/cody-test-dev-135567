"""
Django settings for cody_test_dev_135567 project.
...
ROOT_URLCONF = 'cody_test_dev_135567.urls'
...
WSGI_APPLICATION = 'cody_test_dev_135567.wsgi.application'
...
SPECTACULAR_SETTINGS = {
    ...
    "TITLE": "cody_test_dev_135567 API",
    "DESCRIPTION": "API documentation for cody_test_dev_135567 App",
    "VERSION": "v1",
}
